...
// Elements
const labelWelcome = <HTMLParagraphElement>document.querySelector('.welcome');
const labelDate = <HTMLSpanElement>document.querySelector('.date');
const labelBalance = <HTMLParagraphElement>(
	document.querySelector('.balance__value')
);
const labelSumIn = <HTMLParagraphElement>(
	document.querySelector('.summary__value--in')
);
const labelSumOut = <HTMLParagraphElement>(
	document.querySelector('.summary__value--out')
);
const labelSumInterest = <HTMLParagraphElement>(
	document.querySelector('.summary__value--interest')
);
const labelTimer = <HTMLSpanElement>document.querySelector('.timer');

const containerApp = <HTMLElement>document.querySelector('.app');
const containerMovements = <HTMLDivElement>document.querySelector('.movements');

const btnLogin = <HTMLButtonElement>document.querySelector('.login__btn');
const btnTransfer = <HTMLButtonElement>(
	document.querySelector('.form__btn--transfer')
);
...
const inputLoginUsername = <HTMLInputElement>(
	document.querySelector('.login__input--user')
);
...
const inputTransferAmount = <HTMLInputElement>(
	document.querySelector('.form__input--amount')
);
const inputLoanAmount = <HTMLInputElement>(
	document.querySelector('.form__input--loan-amount')
);
